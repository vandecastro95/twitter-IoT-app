...
const TwitterContextProvider = ({ children }) => {
    ...
    const [ data, loading, errorMessage ] = useFetch('/tweets') 
    const [ buzzWords, setBuzzWords ] = useState([])
    const stopWords = [
        'i', "", "RT", "A", "The", "&amp;",'me','my','myself','we','our','ours','ourselves','you','your',
    ...
    return ( 
        <TwitterContext.Provider value={{ data, buzzWords, loading, errorMessage}}>
        {children}
